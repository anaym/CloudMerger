...
namespace CloudMerger.HostingsManager
{
    public class ServicesCollection
    {
        ...
        public IEnumerable<string> ManagerNames => managers.Keys;
        public IEnumerable<string> MultiHostingManagerNames => multiHostingManagers.Keys;
        public IEnumerable<IHostingManager> Managers => managers.Values;
        public IEnumerable<IMultiHostingManager> MultiHostingManagers => multiHostingManagers.Values;

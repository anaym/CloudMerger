...
namespace CloudMerger.Application
{
    ...
    public class MergedHosting : IFileHosting
    {
        public const string ServiceName = "Merged Hosing";

        public MergedHosting(IFileHosting[] hostings, TimeSpan timeout)
        {
        ...
        {
            Dictionary<Task<ItemInfo>, IFileHosting> sources = null;
        ...
        private readonly IFileHosting[] hostings;
